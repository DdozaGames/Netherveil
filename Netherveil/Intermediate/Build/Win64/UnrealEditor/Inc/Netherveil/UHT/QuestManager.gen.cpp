...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AQuestManager_OnRiftDestroyed_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Quest/QuestManager.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AQuestManager_OnRiftDestroyed_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AQuestManager, nullptr, "OnRiftDestroyed", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00040401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_AQuestManager_OnRiftDestroyed_Statics::Function_MetaDataParams), Z_Construct_UFunction_AQuestManager_OnRiftDestroyed_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UFunction_AQuestManager_OnRiftDestroyed()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
