...
template<> NETHERVEIL_API UScriptStruct* StaticStruct<FQuestData>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_TargetRift_MetaData[];
#endif
		static const UECodeGen_Private::FClassPropertyParams NewProp_TargetRift;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FQuestData_Statics::NewProp_TargetRift_MetaData[] = {
		{ "Category", "Quest" },
		{ "ModuleRelativePath", "Public/Quest/QuestData.h" },
	};
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FQuestData_Statics::NewProp_TargetRift = { "TargetRift", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FQuestData, TargetRift), Z_Construct_UClass_UClass, Z_Construct_UClass_ARift_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQuestData_Statics::NewProp_TargetRift_MetaData), Z_Construct_UScriptStruct_FQuestData_Statics::NewProp_TargetRift_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FQuestData_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FQuestData_Statics::NewProp_TargetRift,
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_PC_1M_Desktop_UnrealProject_Netherveil_Netherveil_Source_Netherveil_Public_Quest_QuestData_h_Statics::ScriptStructInfo[] = {
		{ FQuestData::StaticStruct, Z_Construct_UScriptStruct_FQuestData_Statics::NewStructOps, TEXT("QuestData"), &Z_Registration_Info_UScriptStruct_QuestData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQuestData), 3991042242U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_PC_1M_Desktop_UnrealProject_Netherveil_Netherveil_Source_Netherveil_Public_Quest_QuestData_h_1234832252(TEXT("/Script/Netherveil"),
		nullptr, 0,
