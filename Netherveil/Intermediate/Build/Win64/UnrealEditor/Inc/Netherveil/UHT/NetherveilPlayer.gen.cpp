...
// End Cross Module References
	...
	struct NetherveilPlayer_eventEnterNewStageUI_Parms
	{
		int32 stageIndex;
	};
	...
	static FName NAME_ANetherveilPlayer_EnterNewStageUI = FName(TEXT("EnterNewStageUI"));
	void ANetherveilPlayer::EnterNewStageUI(int32 stageIndex)
	{
		NetherveilPlayer_eventEnterNewStageUI_Parms Parms;
		Parms.stageIndex=stageIndex;
		ProcessEvent(FindFunctionChecked(NAME_ANetherveilPlayer_EnterNewStageUI),&Parms);
	}
	...
	struct Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics
	{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::NewProp_stageIndex = { "stageIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(NetherveilPlayer_eventEnterNewStageUI_Parms, stageIndex), METADATA_PARAMS(0, nullptr) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::NewProp_stageIndex,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::Function_MetaDataParams[] = {
		{ "Category", "Quest" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd \xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd \xef\xbf\xbd\xef\xbf\xbd UI \xef\xbf\xbd\xcb\xbe\xef\xbf\xbd\n" },
#endif
		{ "ModuleRelativePath", "Public/Player/NetherveilPlayer.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd \xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd\xef\xbf\xbd \xef\xbf\xbd\xef\xbf\xbd UI \xef\xbf\xbd\xcb\xbe\xef\xbf\xbd" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ANetherveilPlayer, nullptr, "EnterNewStageUI", nullptr, nullptr, Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::PropPointers), sizeof(NetherveilPlayer_eventEnterNewStageUI_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020800, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::Function_MetaDataParams), Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::PropPointers) < 2048);
	static_assert(sizeof(NetherveilPlayer_eventEnterNewStageUI_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BulletPool_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_BulletPool;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_grenadeSound_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_grenadeSound;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_sniperSound_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_sniperSound;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_questProgress_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_questProgress;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bossProgress_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_bossProgress;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ANetherveilPlayer_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ANetherveilPlayer_EnterNewStageUI, "EnterNewStageUI" }, // 1588486977
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_BulletPool_MetaData[] = {
		{ "Category", "NetherveilPlayer" },
		{ "ModuleRelativePath", "Public/Player/NetherveilPlayer.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_BulletPool = { "BulletPool", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANetherveilPlayer, BulletPool), Z_Construct_UClass_ABulletPool_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_BulletPool_MetaData), Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_BulletPool_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp__crosshairUI = { "_crosshairUI", nullptr, (EPropertyFlags)0x001000000009000d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANetherveilPlayer, _crosshairUI), Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp__crosshairUI_MetaData), Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp__crosshairUI_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_grenadeSound_MetaData[] = {
		{ "Category", "Sound" },
#if !UE_BUILD_SHIPPING
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_grenadeSound = { "grenadeSound", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANetherveilPlayer, grenadeSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_grenadeSound_MetaData), Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_grenadeSound_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_sniperSound_MetaData[] = {
		{ "Category", "Sound" },
		{ "ModuleRelativePath", "Public/Player/NetherveilPlayer.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_sniperSound = { "sniperSound", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANetherveilPlayer, sniperSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_sniperSound_MetaData), Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_sniperSound_MetaData) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_questProgress_MetaData[] = {
		{ "Category", "Quest" },
		{ "ModuleRelativePath", "Public/Player/NetherveilPlayer.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_questProgress = { "questProgress", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANetherveilPlayer, questProgress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_questProgress_MetaData), Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_questProgress_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_bossProgress_MetaData[] = {
		{ "Category", "Quest" },
		{ "ModuleRelativePath", "Public/Player/NetherveilPlayer.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_bossProgress = { "bossProgress", nullptr, (EPropertyFlags)0x0010000000010005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ANetherveilPlayer, bossProgress), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_bossProgress_MetaData), Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_bossProgress_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANetherveilPlayer_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_BulletPool,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_grenadeSound,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_sniperSound,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_questProgress,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANetherveilPlayer_Statics::NewProp_bossProgress,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_PC_1M_Desktop_UnrealProject_Netherveil_Netherveil_Source_Netherveil_Public_Player_NetherveilPlayer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANetherveilPlayer, ANetherveilPlayer::StaticClass, TEXT("ANetherveilPlayer"), &Z_Registration_Info_UClass_ANetherveilPlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANetherveilPlayer), 2278162650U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_PC_1M_Desktop_UnrealProject_Netherveil_Netherveil_Source_Netherveil_Public_Player_NetherveilPlayer_h_638386395(TEXT("/Script/Netherveil"),
